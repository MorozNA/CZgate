...
def get_V1(params: YOperatorDerived, t=None):
...
def get_V2(params: YOperatorDerived, t=None):
...
def get_W0z(params: YOperatorDerived, t):
    const_w0z = get_OM_eff(params, t).conj() * 1j * HBAR / params.Z_ast / params.p0z
