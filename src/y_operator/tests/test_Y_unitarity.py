...
# from src.y_operator.get_integrals import integrate_matrix_A, integrate_matrix_B
...
def test_final_integral_fun():
    ...
    integral_A = get_integral_atom_A(t_initial, t_final, om, tau, delta, xi, q, n)
    integral_B = get_integral_atom_B(t_initial, t_final, om, tau, delta, xi, q, n)
...
def test_Y_unitarity():
    ...
    Y_A = construct_Y_A(t_initial, t_final, om, tau, delta, xi, q, n)
    Y_B = construct_Y_B(t_initial, t_final, om, tau, delta, xi, q, n)
