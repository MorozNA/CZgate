import numpy as np
from src.calculations.algorithm_tools import calculate_rho_wx, calculate_rho_SX
from src.calculations.algorithm_tools import calculate_spin_density_withX
