...
fidelity_iter1 = np.load('data/temp5_fidelity_iter1.npy')
fidelity_iter5 = np.load('data/temp5_fidelity_iter5.npy')
fidelity_iter10 = np.load('data/temp5_fidelity_iter10.npy')
fidelity_iter15 = np.load('data/temp5_fidelity_iter15.npy')
fidelity_iter20 = np.load('data/temp5_fidelity_iter20.npy')
fidelity_iter25 = np.load('data/temp5_fidelity_iter25.npy')
tau_array = np.load('data/temp5_tau.npy')
...
plt.plot(x, fidelity_iter20, 'purple', linewidth=2, label='20 iterations')
plt.plot(x, fidelity_iter25, 'k', linewidth=2, label='25 iterations')
...
plt.title(r"Fidelity vs Gate Time at 5 $\mu$K", fontsize=14, pad=20)
