...
from src.calculations_no_leakage.for_server.distribution_change.temp0_distr_init import rho_TA_0, rho_TB_0, rho_S0, Q, n
...
np.save('plotting_codes/temp0_rho_TA_list.npy', np.array(rho_TA_list))
np.save('plotting_codes/temp0_rho_TB_list.npy', np.array(rho_TB_list))
