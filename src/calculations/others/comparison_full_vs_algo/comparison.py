...
from src.calculations.comparison_full_vs_algo.initial_parameters import calc_rho, rho_TA, rho_TB, rho_full, n
from src.calculations.comparison_full_vs_algo.initial_parameters import YA, YB, U0, full_U
from src.calculations.comparison_full_vs_algo.metrics_fun import generalized_fidelity
...
for i in tqdm(range(iterations)):
    ...
    fidelity_vib_diag.append(generalized_fidelity(np.diag(np.diag(rho_full_vib)), rho_vib_alg))
