from src.calculations.delta_R.test_effects.iterations_calc import fidelity0, fidelity1, fidelity5, iterations
...
plt.plot(range(iterations), 1 - np.array(fidelity5), color='green', linewidth=2, label=r'$T = 5 \mu K$')
