...
from src.calculations_no_leakage.for_server.temp0.temp0_initial import rho_TA_0, rho_TB_0, rho_S0, Q, n
...
np.save('temp1_tau.npy', tau_array)
np.save('temp1_fidelity_iter1.npy', np.array(fidelity_iter1))
np.save('temp1_fidelity_iter5.npy', np.array(fidelity_iter5))
np.save('temp1_fidelity_iter10.npy', np.array(fidelity_iter10))
np.save('temp1_fidelity_iter15.npy', np.array(fidelity_iter15))
np.save('temp1_fidelity_iter20.npy', np.array(fidelity_iter20))
np.save('temp1_fidelity_iter25.npy', np.array(fidelity_iter25))
np.save('temp1_rho_TA_tau400_list.npy', np.array(rho_TA_tau400_list))
np.save('temp1_rho_TB_tau400_list.npy', np.array(rho_TB_tau400_list))