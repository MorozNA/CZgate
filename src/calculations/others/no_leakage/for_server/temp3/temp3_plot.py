...
fidelity_iter1 = np.load('data/temp3_fidelity_iter1.npy')
fidelity_iter5 = np.load('data/temp3_fidelity_iter5.npy')
fidelity_iter10 = np.load('data/temp3_fidelity_iter10.npy')
fidelity_iter15 = np.load('data/temp3_fidelity_iter15.npy')
fidelity_iter20 = np.load('data/temp3_fidelity_iter20.npy')
fidelity_iter25 = np.load('data/temp3_fidelity_iter25.npy')
tau_array = np.load('data/temp3_tau.npy')
...
plt.title(r"Fidelity vs Gate Time at 3 $\mu$K", fontsize=14, pad=20)
