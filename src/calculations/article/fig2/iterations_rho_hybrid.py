...
cfg = YOperatorConfig(
    W_INT_CONSTANT=W_INT_FLAG,
    Q_INT_CONSTANT=Q_INT_FLAG,
    om_hz=5e6,
    n=n
)
...
for i in tqdm(range(iterations)):
    _, _, rho_el_T0, rho_T0_A, rho_T0_B = one_iteration_order2(rho_elmotA_T0, rho_elmotB_T0, rho_el_T0, rho_T0_A, rho_T0_B, U01, YA1, YB1)
    rho_elmotA_T0 = np.kron(rho_el_T0, rho_T0_A)
    rho_elmotB_T0 = np.kron(rho_el_T0, rho_T0_B)
    _, _, rho_el_T0, rho_T0_A, rho_T0_B = one_iteration_order2(rho_elmotA_T0, rho_elmotB_T0, rho_el_T0, rho_T0_A, rho_T0_B, U02, YA2, YB2)
    rho_elmotA_T0 = np.kron(rho_el_T0, rho_T0_A)
    rho_elmotB_T0 = np.kron(rho_el_T0, rho_T0_B)
